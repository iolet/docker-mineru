...
class Default_(object):
    ...
    def APP_NAME(self) -> str:
        return self.env_pair.get('APP_NAME') or 'mineru-pdf'

    @property
    def APP_URL(self) -> str:
        return self.env_pair.get('APP_URL') or 'http://localhost:9471'
    ...
    def DB_USERNAME(self) -> str:
        return self.env_pair.get('DB_USERNAME') or 'mineru'

    @property
    def DB_PASSWORD(self) -> str:
        return self.env_pair.get('DB_PASSWORD') or 'mineru'
